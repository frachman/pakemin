...
Context contains stable project knowledge for the sample SaaS repository.

Parent: [Portable core](../README.md)

## Documents

- [Product](product.md): describes the sample product and users.
- [Project](project.md): summarizes the v1.0 project context.
