...
Pakemin needs a portable representation for project knowledge that can be read by humans, reviewed in Git, and consumed by multiple AI coding agents.
...
Markdown is the default portable representation for Pakemin documentation and project knowledge.
