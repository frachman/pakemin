...
- Governance source boundaries are accepted in [ADR-0012](../adr/0012-governance-source-boundaries.md); the declarative governance schema is proposed in [ADR-0013](../adr/0013-declarative-governance-schema.md).
